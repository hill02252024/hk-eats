...
| E14 | 顯示層走樣：nav 分區名同 `SECTIONS` 唔一致、nav 少咗分區連結、footer 冇品牌名、或者顯示槽位仲有舊字串 |
...
| 同其他有咩唔同 | 比較判斷 | data 嘅 `apps.<name>.diff` |
...
- **唔准寫版本號、評分、下載量、宣傳語氣。**
- **「同其他有咩唔同」唔准由本站自己填。**要講比較，就要真係用過同類產品；
  未用過就留 `needsVerify`，唔好靠猜。
